(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    countSelectedText: function (numSelected, numTotal) {
      return (numSelected == 1) ? "{0} 项被选中" : "{0} 项被选中";
    },
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<button type="button" class="actions-btn bs-select-all btn ' + classNames.BUTTONCLASS + '" style="margin-right: 0px;padding-right:5px;padding-left:5px;">' +
      this.options.selectAllText +
      '</button>' +
      '<button type="button" class="actions-btn bs-deselect-all btn ' + classNames.BUTTONCLASS + '" style="margin-right: 0px;padding-right:5px;padding-left:5px;">' +
